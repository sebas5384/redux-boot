...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(40);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _tape = __webpack_require__(45);
	
	var _tape2 = _interopRequireDefault(_tape);
	
	var _bootstrap = __webpack_require__(80);
	
	var _bootstrap2 = _interopRequireDefault(_bootstrap);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _tape2.default)('Boostrap new app with no arguments', function (assert) {
	  var app = (0, _bootstrap2.default)();
	
	  assert.deepLooseEqual((0, _ownKeys2.default)(app.store), ['dispatch', 'subscribe', 'getState', 'replaceReducer'], 'Store created');
	
	  assert.end();
	});
	
	(0, _tape2.default)('Boostrap new app with an initial state', function (assert) {
	  var initialState = {
	    variables: {
	      name: 'Test app'
	    }
	  };
	  var app = (0, _bootstrap2.default)(initialState);
	
	  assert.deepEqual(app.store.getState(), initialState, 'State is equal to initial state');
	
	  assert.end();
	});
	
	(0, _tape2.default)('Boostrap new app with a module implementing a reducer', function (assert) {
	  var initialState = {
	    foo: 'bar'
	  };
	  ...
	  var testModule = {
	    reducer: function reducer(state, action) {
	      if (action.type === _bootstrap.BOOT) {
	  ...
	  var app = (0, _bootstrap2.default)(initialState, modules);
	
	  assert.equal(app.store.getState().foo, 'baz', 'Module reducer changed state');
	
	  assert.end();
	});
	
	(0, _tape2.default)('Boostrap new app with a module implementing a middleware', function (assert) {
	  var AFTER_BOOT = 'choko/core/test/AFTER_BOOT';
	
	  var afterBoot = function afterBoot(value) {
	    return {
	      type: AFTER_BOOT,
	      payload: {
	        foo: value
	  ...
	  assert.equal(app.store.getState().foo, 'baz', 'Module middle dispatched an action that changed state');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(8).Reflect.ownKeys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S, 'Reflect', {ownKeys: __webpack_require__(43)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createDefaultStream = __webpack_require__(47);
	var Test = __webpack_require__(51);
	var createResult = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__dirname) {var deepEqual = __webpack_require__(52);
	var defined = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(57).inherits
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $isFinite = __webpack_require__(69);
	
	var sign = __webpack_require__(70);
	var mod = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isPrimitive = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(56);
	var through = __webpack_require__(48);
	var resumer = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.bootAction = exports.BOOT = undefined;
	...
	var _reduxActions = __webpack_require__(130);
	
	var _reduxPromise = __webpack_require__(142);
	...
	var BOOT = exports.BOOT = 'choko/core/BOOT';
	...
	function bootstrap() {
	  ...
	  var reducersFromModules = modules.filter(function (module) {
	    return typeof module.reducer == 'function' || (0, _typeof3.default)(module.reducer) == 'object';
	  }).map(function (module) {
	    return typeof module.reducer == 'function' ? module.reducer : (0, _reduxActions.handleActions)(module.reducer);
	  });
	
	  var middlewaresFromModules = modules.filter(function (module) {
	    return typeof module.middleware == 'function';
	  }).map(function (module) {
	    return module.middleware;
	  });
	
	  middlewaresFromModules.unshift(_reduxPromise2.default);
	
	  var rootReducer = (0, _combineReducers2.default)(reducersFromModules);
	
	  var store = (0, _redux.createStore)(rootReducer, initialState, _redux.applyMiddleware.apply(undefined, (0, _toConsumableArray3.default)(middlewaresFromModules)));
	...
	var bootAction = exports.bootAction = (0, _reduxActions.createAction)(BOOT);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(11)(IteratorPrototype, __webpack_require__(95)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(95)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(123),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(131);
	
	var _createAction2 = _interopRequireDefault(_createAction);
	
	var _handleAction = __webpack_require__(132);
	
	var _handleAction2 = _interopRequireDefault(_handleAction);
	
	var _handleActions = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fluxStandardAction = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(140);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _reduceReducers = __webpack_require__(141);
...
/***/ function(module, exports) {
	...
	function combineReducers(reducers) {
	  return function (currentState, action) {
	    var state = reducers.reduce(function (prevState, reducer) {
